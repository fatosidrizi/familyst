package com.crud.famylist.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.crud.famylist.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.crud.famylist.repository.UserRepository.USERS_BY_EMAIL_CACHE);
