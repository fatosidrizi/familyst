...
export class ShoppingListComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    this.shoppingListService
      ...
      .subscribe((res: HttpResponse<IShoppingList[]>) => this.paginateShoppingLists(res.body, res.headers));
  }
  ...
  registerChangeInShoppingLists(): void {
    this.eventSubscriber = this.eventManager.subscribe('shoppingListListModification', () => this.reset());
  }
  ...
  protected paginateShoppingLists(data: IShoppingList[] | null, headers: HttpHeaders): void {
